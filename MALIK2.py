...
print("\033[0;91mThis Tool's Free By MALIK vai")

psb('\x1b[1;92mPAKISTAN 6 DIGIT CLONING START PLEASE WAIT .....')
...
def menu():
    ...
    print '\033[0;93mAUTHOR   : MALIK-VAU'

    print '\033[0;94mFACEBOOK : AYESHA MALIK'

    print '\033[0;96mGITHUB   : MALIK'
    ...
    print '\033[0;90m[0]  \x1b[1;90mPakistan numers clone            '
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[MALIK-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;91m[MALIK-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
